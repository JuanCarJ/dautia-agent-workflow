...
| Feature/cambio definido | Mapear impacto -> implementer Sol medium para bloque independiente resuelto con trabajo concurrente util -> comprobar comportamiento nuevo y recorrido previo afectado -> revision/integracion autorizada. Sin discovery o redesign cuando ya esta resuelto. |
