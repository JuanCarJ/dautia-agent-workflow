...
Record build variant, device/emulator, Android version, commands, evidence, failures, and untested areas. Distinguish product, environment, and test-infrastructure failures.
