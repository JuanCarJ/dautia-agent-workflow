...
Return required platform execution requests to the parent orchestrator only where they add distinct evidence; do not spawn platform agents yourself. Synthesize completed evidence and keep parity/readiness unverified when a required platform or candidate boundary remains unproven. Performance, memory, offline, lifecycle, deep accessibility, multi-device/browser, and full regression require a named risk or gate.
