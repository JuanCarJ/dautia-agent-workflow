...
Do not commit, push, create PRs, deploy, promote, or mutate production without exact delegated authority. Avoid adjacent refactors, unrelated redesign and infrastructure expansion; remove only code made newly orphaned by your change, while retaining necessary error recovery, security and accessibility behavior.
