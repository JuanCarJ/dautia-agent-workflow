...
Record commit, scheme, configuration, simulator, iOS version, commands, evidence, failures, and untested areas. Distinguish product, environment, signing, and test-infrastructure failures.
